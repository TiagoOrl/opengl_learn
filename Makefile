...
OBJECTS = ./build/stb.o ./build/glad.o ./build/Shader.o ./build/VAO.o ./build/EBO.o ./build/Texture.o ./build/Position.o
...
./build/Position.o: ./src/Position.cpp
	${CC} ./src/Position.cpp -c -o ./build/Position.o ${INCLUDE_TAG} -g
